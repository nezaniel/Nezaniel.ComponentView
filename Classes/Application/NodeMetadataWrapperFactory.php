...
final readonly class NodeMetadataWrapperFactory
{
    ...
    public function forNode(Node $node, ComponentInterface|\PackageFactory\Neos\ComponentEngine\ComponentInterface|string $content, ?string $additionalClasses = null): NodeMetadataWrapper
    {
